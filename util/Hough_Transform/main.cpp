...
int main(int argc, char* argv[])
{
    ...
    float gradient[gray.rows-2][gray.cols -2] = {0};
    float angle[gray.rows-2][gray.cols -2] = {0};
    ...
    while(1)
    {
        ...
        {
            for(int j=0; j<houghlines.cols; j++){houghlines.at<uchar>(i, j)=0;}
        }
        ...
        //resize(hough, hough, Size(canny.cols, canny.rows));
